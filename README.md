...
- 🏛️ President, Vietnamese Student Association (VSA) — 2026–2027
...
**Backend/Infra:** Django, Django REST Framework, Celery, Redis, Supabase, Docker, AWS, Azure

**Data/Tools:** Streamlit, pytest, Git, GitHub
...
📌 **Web Analytics Pipeline** — [here](#)
Description: A pipeline for ingesting and analyzing web traffic data.
